...
const SAWALA_DEFAULT_CONFIG = {
  ...
  pricing: {
    ...
    plans: [
      { name: "Self-Hosted", desc: "Install via start.bat atau installer Windows. Jalan lokal, data tidak keluar dari perangkatmu.", price: "Gratis", ctaLabel: "Download", ctaHref: "#coba", dark: false },
      { name: "Cloud (PM2 + Nginx)", desc: "Deploy di server sendiri untuk dipantau tim dari mana saja via browser.", price: "Hubungi Kami", ctaLabel: "Jadwalkan Demo", ctaHref: "#coba", dark: true },
    ],
  },
  ctaBanner: {
    title: "Siap memantau meeting kamu?",
    subtitle: "Unduh SAWALA dan aktifkan sesi pertamamu dalam hitungan menit.",
    primaryLabel: "Download SAWALA",
    primaryHref: "#",
